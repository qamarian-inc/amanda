...
var (
	iScalarData_vcConfDataProvider_Amanda func (string) (string, error) = iScalarData_ConfDataProvider_Amanda /* To fetch a scalar configuration data (number or string) use this interface.
	...
	iSliceData_vcConfDataProvider_Amanda func (string) ([]string, error) = iSliceData_ConfDataProvider_Amanda /* To fetch an array configuration data use this interface. The interface requires one parametre which should be the name of the data to be fetched.
	...
	iMapData_vcConfDataProvider_Amanda func (string) (map[string]string, error) = iMapData_ConfDataProvider_Amanda /* To fetch a map configuration data use this interface. The interface requires one parametre which should be the name of the data to be fetched.
