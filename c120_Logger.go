...
/* This component implements a synchronous logger. It doesn't trigger the creation of more than one OS thread. On startup, the init () function starts the logger (as a goroutine), and logs can be sent to this logger, using function logger ().

To gracefully shutdown the logger, call function: logger___Shutdown ().
*/
